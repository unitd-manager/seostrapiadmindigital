...
export interface ApiCheckoutRecordCheckoutRecord
  extends Struct.CollectionTypeSchema {
  collectionName: 'checkout_records';
  info: {
    displayName: 'Checkout Record';
    pluralName: 'checkout-records';
    singularName: 'checkout-record';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    amountMajor: Schema.Attribute.Decimal;
    amountMinor: Schema.Attribute.BigInteger;
    checkoutReference: Schema.Attribute.String & Schema.Attribute.Unique;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.String;
    customerCompany: Schema.Attribute.String;
    customerCountry: Schema.Attribute.String;
...
export interface ApiResourcePageResourcePage
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    legacyPageDocumentId: Schema.Attribute.String;
    legacyPageId: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::checkout-record.checkout-record': ApiCheckoutRecordCheckoutRecord;
